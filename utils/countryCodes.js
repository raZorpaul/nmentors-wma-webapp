...
const fileContent = `export const updatedCountryCodes = ${JSON.stringify(
  updatedCountryCodes,
  null,
  2
)};`;
...
async function saveToFile() {
  try {
    await writeFile("updatedCountryCodes.js", fileContent);
    console.log("File successfully written as updatedCountryCodes.js");
  } catch (err) {
